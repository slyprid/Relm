...
{
    public class AnimatedOldSprite
        : OldSprite
    {
        ...
        public Action<AnimatedOldSprite> OnComplete { get; set; }
        public bool IsComplete { get; set; }

        public AnimatedOldSprite(Texture2D texture, int frameWidth, int frameHeight, int frameDuration)
        {
