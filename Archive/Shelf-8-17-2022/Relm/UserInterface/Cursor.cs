...
namespace Relm.UserInterface
{
        ...
        : BaseControl
    {
        ...
        private void Initialize()
        {
            ...
            _oldSprite = AddChild<ChildControl>(TextureAtlas)
        ...
        public override void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            _oldSprite.Position = position;
            _oldSprite.Draw(gameTime, spriteBatch);
        }
        ...
        {
            return $"{Position} => {_oldSprite.Position}";
        }
