...
namespace Relm.Content.Pipeline.BitmapFonts
{
	...
	public class BitmapFontWriter : ContentTypeWriter<BitmapFontProcessorResult>
	{
		...
		{
			return "Relm.Assets.BitmapFonts.BitmapFont, Relm, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null";
		}


		public override string GetRuntimeReader(TargetPlatform targetPlatform)
		{
			return "Relm.Assets.BitmapFonts.BitmapFontReader, Relm, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null";
		}
	}
}