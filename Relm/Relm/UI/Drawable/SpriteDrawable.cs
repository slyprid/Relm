...
namespace Relm.UI.Drawable
{
	public class SpriteDrawable : IDrawable
	{
		...
		public virtual void Draw(SpriteBatch spriteBatch, float x, float y, float width, float height, Color color)
		{
			if (TintColor.HasValue)
				color = ColorExtensions.Multiply(color, TintColor.Value);

            spriteBatch.Draw(Sprite, new Rectangle((int)x, (int)y, (int)width, (int)height), Sprite.SourceRect, color, SpriteEffects);
		}
