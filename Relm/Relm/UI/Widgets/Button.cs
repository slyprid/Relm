    ...
    public class Button : Table, IInputListener, IGamepadFocusable
	{
		...
		public override float PreferredWidth
		{
			get
			{
				...
				if (style.Up != null)
					prefWidth = System.Math.Max(prefWidth, style.Up.MinWidth);
				if (style.Down != null)
					prefWidth = System.Math.Max(prefWidth, style.Down.MinWidth);
				if (style.Checked != null)
					prefWidth = System.Math.Max(prefWidth, style.Checked.MinWidth);
				return prefWidth;
			}
		}
		...
		public override float PreferredHeight
		{
			get
			{
				...
				if (style.Up != null)
					prefHeight = System.Math.Max(prefHeight, style.Up.MinHeight);
				if (style.Down != null)
					prefHeight = System.Math.Max(prefHeight, style.Down.MinHeight);
				if (style.Checked != null)
					prefHeight = System.Math.Max(prefHeight, style.Checked.MinHeight);
				return prefHeight;
			}
		}
