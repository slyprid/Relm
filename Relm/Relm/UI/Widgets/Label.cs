...
namespace Relm.UI.Widgets
{
	public class Label : Element
	{
		...
		public Label(string text) : this(text, RelmGraphics.Instance.BitmapFont)
		{ }
		...
		public override void Draw(SpriteBatch spriteBatch, float parentAlpha)
		{
			...
			_style.Background?.Draw(spriteBatch, x, y, width == 0 ? _prefSize.X : width, height, color);

            spriteBatch.DrawString(_style.Font, _wrappedString, new Vector2(x, y) + _textPosition,
