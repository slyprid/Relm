...
namespace Relm.UI.Containers
{
	public class Container : Group
	{
		...
		public override void Draw(SpriteBatch spriteBatch, float parentAlpha)
		{
			...
			{
				DrawBackground(spriteBatch, parentAlpha, GetX(), GetY());
		...
		protected void DrawBackground(SpriteBatch spriteBatch, float parentAlpha, float x, float y)
		{
			if (_background == null)
				return;

			_background.Draw(spriteBatch, x, y, GetWidth(), GetHeight(), ColorExtensions.Create(color, (int)(color.A * parentAlpha)));
		}
