...
namespace Relm.Components.Renderables.Sprites
{
	public class SpriteRenderer : RenderableComponent
	{
		...
		/// </summary>
		public void DrawOutline(SpriteBatch spriteBatch, Camera camera, int offset = 1) => DrawOutline(spriteBatch, camera, Microsoft.Xna.Framework.Color.Black, offset);

		public void DrawOutline(SpriteBatch spriteBatch, Camera camera, Color outlineColor, int offset = 1)
		{
