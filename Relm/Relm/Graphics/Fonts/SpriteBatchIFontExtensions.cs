...
{
	public static class SpriteBatchIFontExtensions
	{
		public static void DrawString(this SpriteBatch spriteBatch, IFont font, StringBuilder text, Vector2 position,
									  Color color)
		{
			spriteBatch.DrawString(font, text, position, color, 0.0f, Vector2.Zero, new Vector2(1.0f), SpriteEffects.None,
				0.0f);
		}
									  ...
									  float layerDepth)
		{
			...
			font.DrawInto(spriteBatch, text, position, color, rotation, origin, scale, effects, layerDepth);
		}
