...
namespace Relm.Graphics.Transitions
{
	public class SquaresTransition : SceneTransition
	{
		...
		public SquaresTransition(Func<Scene> sceneLoadAction) : base(sceneLoadAction, true)
		{
			...
			_squaresEffect = RelmGame.Content.LoadEffect("Content/nez/effects/transitions/Squares.mgfxo");
		...
		public override IEnumerator OnBeginTransition()
		{
			...
			// populate squares
			yield return RelmGame.StartCoroutine(TickEffectProgressProperty(_squaresEffect, SquaresInDuration, EaseType));
			...
			// unpopulate squares
			yield return RelmGame.StartCoroutine(TickEffectProgressProperty(_squaresEffect, SquaresOutDuration,
			...
			RelmGame.Content.UnloadEffect(_squaresEffect.Name);
		}
		...
		public override void Render(SpriteBatch spriteBatch)
		{
            ...
            spriteBatch.Begin(BlendState.NonPremultiplied, RelmGame.DefaultSamplerState, DepthStencilState.None, null, _squaresEffect);
			...
			if (!_isNewSceneLoaded)
                ...
                spriteBatch.Draw(_overlayTexture, new Rectangle(0, 0, Screen.Width, Screen.Height), Color.Transparent);
