...
namespace Relm.Input
{
        ...
        : VirtualInput
	{
		...
		public class KeyboardKey : Node
		{
			...
			public override bool IsDown => RelmInput.IsKeyDown(Key);


			public override bool IsPressed => RelmInput.IsKeyPressed(Key);


			public override bool IsReleased => RelmInput.IsKeyReleased(Key);
		}
		...
		public class KeyboardModifiedKey : Node
		{
			...
			public override bool IsDown => RelmInput.IsKeyDown(Modifier) && RelmInput.IsKeyDown(Key);


			public override bool IsPressed => RelmInput.IsKeyDown(Modifier) && RelmInput.IsKeyPressed(Key);
		...
		public class GamePadButton : Node
		{
			...
			public override bool IsDown => RelmInput.GamePads[GamepadIndex].IsButtonDown(Button);


			public override bool IsPressed => RelmInput.GamePads[GamepadIndex].IsButtonPressed(Button);


			public override bool IsReleased => RelmInput.GamePads[GamepadIndex].IsButtonReleased(Button);
		}
		...
		public class GamePadLeftTrigger : Node
		{
			...
			public override bool IsDown => RelmInput.GamePads[GamepadIndex].IsLeftTriggerDown(Threshold);

			public override bool IsPressed => RelmInput.GamePads[GamepadIndex].IsLeftTriggerPressed(Threshold);

			public override bool IsReleased => RelmInput.GamePads[GamepadIndex].IsLeftTriggerReleased(Threshold);
		}
		...
		public class GamePadRightTrigger : Node
		{
			...
			public override bool IsDown => RelmInput.GamePads[GamepadIndex].IsRightTriggerDown(Threshold);

			public override bool IsPressed => RelmInput.GamePads[GamepadIndex].IsRightTriggerPressed(Threshold);

			public override bool IsReleased => RelmInput.GamePads[GamepadIndex].IsRightTriggerReleased(Threshold);
		}
		...
		public class GamePadDPadRight : Node
		{
			...
			public override bool IsDown => RelmInput.GamePads[GamepadIndex].DpadRightDown;

			public override bool IsPressed => RelmInput.GamePads[GamepadIndex].DpadRightPressed;

			public override bool IsReleased => RelmInput.GamePads[GamepadIndex].DpadRightReleased;
		}
		...
		public class GamePadDPadLeft : Node
		{
			...
			public override bool IsDown => RelmInput.GamePads[GamepadIndex].DpadLeftDown;

			public override bool IsPressed => RelmInput.GamePads[GamepadIndex].DpadLeftPressed;

			public override bool IsReleased => RelmInput.GamePads[GamepadIndex].DpadLeftReleased;
		}
		...
		public class GamePadDPadUp : Node
		{
			...
			public override bool IsDown => RelmInput.GamePads[GamepadIndex].DpadUpDown;

			public override bool IsPressed => RelmInput.GamePads[GamepadIndex].DpadUpPressed;

			public override bool IsReleased => RelmInput.GamePads[GamepadIndex].DpadUpReleased;
		}
		...
		public class GamePadDPadDown : Node
		{
			...
			public override bool IsDown => RelmInput.GamePads[GamepadIndex].DpadDownDown;

			public override bool IsPressed => RelmInput.GamePads[GamepadIndex].DpadDownPressed;

			public override bool IsReleased => RelmInput.GamePads[GamepadIndex].DpadDownReleased;
		}
		...
		{
			public override bool IsDown => RelmInput.LeftMouseButtonDown;

			public override bool IsPressed => RelmInput.LeftMouseButtonPressed;

			public override bool IsReleased => RelmInput.LeftMouseButtonReleased;
		}


		public class MouseRightButton : Node
		{
			public override bool IsDown => RelmInput.RightMouseButtonDown;

			public override bool IsPressed => RelmInput.RightMouseButtonPressed;

			public override bool IsReleased => RelmInput.RightMouseButtonReleased;
		}


		public class MouseMiddleButton : Node
		{
			public override bool IsDown => RelmInput.MiddleMouseButtonDown;

			public override bool IsPressed => RelmInput.MiddleMouseButtonPressed;

			public override bool IsReleased => RelmInput.MiddleMouseButtonReleased;
		}


		public class MouseFirstExtendedButton : Node
		{
			public override bool IsDown => RelmInput.FirstExtendedMouseButtonDown;

			public override bool IsPressed => RelmInput.FirstExtendedMouseButtonPressed;

			public override bool IsReleased => RelmInput.FirstExtendedMouseButtonReleased;
		}


		public class MouseSecondExtendedButton : Node
		{
			public override bool IsDown => RelmInput.SecondExtendedMouseButtonDown;

			public override bool IsPressed => RelmInput.SecondExtendedMouseButtonPressed;

			public override bool IsReleased => RelmInput.SecondExtendedMouseButtonReleased;
		}
