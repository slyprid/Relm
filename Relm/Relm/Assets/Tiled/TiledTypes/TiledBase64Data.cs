...
{
    public class TiledBase64Data
    {
        public Stream Data { get; private set; }

        public TiledBase64Data(XElement xData)
        {
            if ((string)xData.Attribute("encoding") != "base64")
                throw new Exception("TiledBase64Data: Only Base64-encoded data is supported.");
            ...
            {
                throw new Exception("TiledBase64Data: Unknown compression.");
            }
        }
    }
}