...
namespace Relm.Gui.Inspectors
{
	public static class InspectorCache
	{
		...
		public static Type[] GetAllComponentSubclassTypes()
		{
			...
			{
				var subclasses = Relm.Utils.GetAllSubclasses(typeof(Component), true);
		...
		public static Type[] GetAllEffectSubclassTypes()
		{
			...
			{
				var subclasses = Relm.Utils.GetAllSubclasses(typeof(Effect), true);
		...
		public static Type[] GetAllPostProcessorSubclassTypes()
		{
			...
			{
				var subclasses = Relm.Utils.GetAllSubclasses(typeof(PostProcessor));
