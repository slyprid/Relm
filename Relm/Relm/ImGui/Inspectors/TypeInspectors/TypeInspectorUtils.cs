...
using Relm.Graphics;
using TI = Relm.Gui.Inspectors.TypeInspectors;
...
namespace Relm.Gui.Inspectors.TypeInspectors
{
	public static class TypeInspectorUtils
	{
		...
		public static List<AbstractTypeInspector> GetInspectableProperties(object target)
		{
			...
			var fields = Relm.Utils.GetFields(targetType);
			...
			var properties = Relm.Utils.GetProperties(targetType);
		...
		{
			var methods = Relm.Utils.GetMethods(type);
			foreach (var method in methods)
			{
		...
		static AbstractTypeInspector GetMaterialInspector(object target, MemberInfo memberInfo)
		{
			...
			if (propInfo != null)
			{
				var getter = Relm.Utils.GetPropertyGetter(propInfo);
