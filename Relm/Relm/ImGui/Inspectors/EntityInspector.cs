...
namespace Relm.Gui.Inspectors
{
	public class EntityInspector
	{
		...
		string _entityWindowId = "entity-" + RelmImGui.GetScopeId().ToString();
		...
		public void Draw()
		{
			...
			{
                RelmGame.GetGlobalManager<ImGuiManager>().StopInspectingEntity(this);
				return;
			}
			...
			if (ImGui.Begin($"Entity Inspector: {Entity.Name}###" + _entityWindowId, ref open))
			{
				...
				if (RelmImGui.CenteredButton("Add Component", 0.6f))
				{
