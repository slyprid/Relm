...
namespace Relm
{
    public static class ContentLibrary
    {
        ...
        public static ContentLibrarySection<string, TextureAtlas> IconSets { get; private set; }
        ...
        public static void Initialize()
        {
            ...
            IconSets = new ContentLibrarySection<string, TextureAtlas>(x => x.Name, Content);
        }
    }
}